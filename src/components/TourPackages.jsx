...
return (
    <section className="w-full h-auto flex flex-col justify-center mt-3 pb-8 md:pb-8">
      <h1 className="text-[5vw] bg-[#F49330] md:text-[2.8vw] text-center font-semibold my-6 md:my-12 px-20 sm:px-0 md:py-2 leading-6 sm:leading-normal line-clamp-2">
        Prayagraj MahaKumbh Tour Packages
      </h1>
              ...
              .map((item) => (
                ...
                >
                  <img
                    className="w-full h-auto max-w-[350px] max-h-[200px] shadow-none rounded-t-xl"
                    src={builder.image(item.image).url()}
                    alt={item.name || "Tour packages for Prayagraj Kumbh Mela 2025"}
                  />
                  <div className="text-[3.5vw] md:text-[2vw] lg:text-[1.5vw] font-semibold leading-[4vw] md:leading-[2vw] px-3 my-2">
                    <Stack direction="row" spacing={1}>
                      <Chip label="Trending" color="primary" size="small" />
                    ...
                    <div className="flex justify-between pb-2 px-4">
                      <button
                        className="bg-[#F49330] text-black rounded-lg p-2 text-sm"
                        onClick={() => handleDetailsClick(item)}
      ...
      <button
        className="hover-effect bg-[#F49330] rounded-lg md:rounded-xl px-4 py-2 lg:px-5 w-fit mx-auto font-bold text-[4vw] md:text-[1.5vw] mt-8 md:mt-12  shadow-xl cursor-pointer transition duration-300 hover:bg-[#F88820] hover:text-white"
        onClick={() => navigate("/packages")}
