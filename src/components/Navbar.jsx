  ...
  return (
    <nav>
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 hidden md:flex justify-between bg-black bg-opacity-10 rounded-b-lg w-[70%] lg:w-[50%] px-5 py-3 items-center font-medium text-[1.5vw] lg:text-[14px] text-black z-10 mb-[10%]">
        <a href="index.html" className="hover-effect bg-[#F88820] rounded-lg px-5 py-2 lg:px-9">Home</a>
        <a href="Blog1.html" className="hover-effect">Blogs</a>
        <a href="Gallery.html" className="hover-effect">Picture Gallery</a>
        <a href="Packages.html" className="hover-effect">Packages</a>
        <a href="Enquiry.html" className="hover-effect bg-[#F88820] rounded-lg px-5 py-2 lg:px-9">Enquire Now</a>
      </div>

      <div className="max-w-screen-xl items-center mx-auto px-4 py-2 md:hidden">
        <button
          id="hamburger-btn"
          type="button"
          className="inline-flex items-center justify-center p-2 w-10 h-10 sm:w-12 sm:h-12 text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-black fixed top-[2%]"
