...
return (
    <div>
            ...
            <div className="p-4">
                ...
                <div className="flex flex-col md:flex-row justify-center mt-4">
                    ...
                    <div className="flex items-center mb-4 md:mb-0">
                        ...
                        <h1 className="text-sm ml-3">Top Attractions of Prayagraj and Mahakumbh</h1>
                    </div>
                    <div className="h-12 border-l-2 border-gray-400 px-2 hidden md:block"></div>
        ...
        <div className="w-11/12 mx-auto my-8 bg-[#FF9933] rounded-2xl shadow-lg p-4">
            <h1 className="text-3xl font-bold text-center text-black">Why Choose Us?</h1>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-x-32 gap-y-8 mt-4">
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg">
                    <h1 className="text-xl font-bold text-black text-center">Local Experts</h1>
                    <p className="mt-2">
                ...
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg">
                    <h1 className="text-xl font-bold text-black text-center">Unique Experiences</h1>
                    <p className="mt-2">
                ...
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg">
                    <h1 className="text-xl font-bold text-black text-center">Delicious Street Food</h1>
                    <p className="mt-2">
                ...
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg">
                    <h1 className="text-xl font-bold text-black text-center">New Yet Committed</h1>
                    <p className="mt-2">
                ...
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg">
                    <h1 className="text-xl font-bold text-black text-center">Personalized & Flexible Tours</h1>
                    <p className="mt-2">
                ...
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg">
                    <h1 className="text-xl font-bold text-black text-center">Transparent Pricing</h1>
                    <p className="mt-2">
        ...
        <div className="w-11/12 mx-auto my-8 bg-[#FF9933] rounded-2xl shadow-lg p-4">
            <h1 className="text-3xl font-bold text-center text-black">Trusted by 500+ Devotees</h1>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-32 gap-y-8 mt-4">
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg text-center">
                    ...
                    <h1 className="text-xl font-bold text-black text-center">~Rahul Verma</h1>
                </div>
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg text-center">
                    <p className="mt-2">
                    ...
                    <Rating name="read-only" value={5} readOnly className="pt-4" />
                    <h1 className="text-xl font-bold text-black text-center">~Priya Sharma</h1>
                </div>
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg text-center">
                    <p className="mt-2">
                    ...
                    <Rating name="read-only" value={5} readOnly className="pt-4" />
                    <h1 className="text-xl font-bold text-black text-center">~Ankit Joshi</h1>
                </div>
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg text-center">
                    <p className="mt-2">
                    ...
                    <h1 className="text-xl font-bold text-black text-center">~Neha Kapoor</h1>
                </div>
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg text-center">
                    <p className="mt-2">
                    ...
                    <Rating name="read-only" value={5} readOnly className="pt-4" />
                    <h1 className="text-xl font-bold text-black text-center">~Suresh Nair</h1>
                </div>
                <div className="bg-[#F4F2E9] p-4 rounded-lg shadow-lg text-center">
                    <p className="mt-2">
                    ...
                    <h1 className="text-xl font-bold text-black text-center">~Vishal Singh</h1>
                </div>
            </div>
        </div>
