  ...
  return (
    <div>
      ...
      <div className="w-[90%] md:w-[80%] mx-auto bg-[#F88820] p-6 rounded-xl mt-[5%] md:rounded-3xl shadow-md text-black mb-8">
        <h1 className="text-center text-[5vw] md:text-[3vw] font-bold mb-6 font-serif">Enquiry Form</h1>

        {/* Form Section */}
        <form onSubmit={handleSubmit} id="enquiryForm" className="grid md:grid-cols-2 gap-[4vw] px-[2vw] mx-auto">
          <div>
            <label htmlFor="name" className="block md:text-[1.5vw] font-medium mb-1">👤 Name:</label>
            <input
              type="text"
              id="name"
              name="name"
          ...
          <div>
            <label htmlFor="email" className="block md:text-[1.5vw] font-medium mb-1">✉️ Email:</label>
            <input
              type="email"
              id="email"
              name="email"
          ...
          <div>
            <label htmlFor="phone" className="block md:text-[1.5vw] font-medium mb-1">📞 Phone:</label>
            <input
              type="tel"
              id="phone"
              name="phone"
              ...
              required
            />
            <small className="text-sm text-gray-700">Format: +XX ISD CODE PHONE</small>
          </div>

          <div>
            <label htmlFor="country" className="block md:text-[1.5vw] font-medium mb-1">🌍 Country of Residence:</label>
            <input
              type="text"
              id="country"
              name="country"
          ...
          <div>
            <label htmlFor="date" className="block md:text-[1.5vw] font-medium mb-1">📅 Date of Arrival:</label>
            <input
              type="date"
              id="date"
              name="date"
          ...
          <div>
            <label htmlFor="duration" className="block md:text-[1.5vw] font-medium mb-1">⏰ Duration (In Days):</label>
            <input
              type="number"
              id="duration"
              name="duration"
        ...
        <p className="text-center md:text-xl text-lg mt-4">*After filling this form we will contact you within the next 6 hours.</p>
      </div>

      {/* Success Message Modal */}
      {showModal && (
        <div id="successModal" className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
          <div className="bg-[#F49330] text-center p-6 rounded-lg shadow-lg w-[80%] md:w-[40%]">
            <p className="text-white text-lg font-bold">
              Thanks For submitting the form, We will contact you very soon.<br />!!JAI SHREE RAM!!
            </p>
            <button
              id="okayButton"
